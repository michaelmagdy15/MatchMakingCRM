  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Candidate Tasks</h2>
          <p className="text-muted-foreground">Manage your follow-ups, calls, and actions with matchmaking candidates.</p>
        </div>
                ...
                <CardContent className="p-3.5 sm:p-5 flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-4 mt-4 text-xs text-muted-foreground">
                      ...
                      {relatedClient && (
                        <div className="flex items-center gap-1">
                          <span className="font-medium">Candidate:</span> {relatedClient.code || relatedClient.name || 'C-XXX'}
                        </div>
                      )}
                    </div>
                  </div>
