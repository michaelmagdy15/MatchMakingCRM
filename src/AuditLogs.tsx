...
export default function AuditLogs() {
  ...
  const getEntityBadge = (entity: AuditLog['entityType']) => {
    switch (entity) {
      case 'CLIENT': return <Badge variant="outline" className="border-blue-200 text-blue-700 bg-blue-50">Profile</Badge>;
      case 'LEAD': return <Badge variant="outline" className="border-amber-200 text-amber-700 bg-amber-50">Lead</Badge>;
      case 'PACKAGE_RECORD': return <Badge variant="outline" className="border-purple-200 text-purple-700 bg-purple-50">Match Proposal</Badge>;
    ...
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-md">
          System history is exclusively visible to Youssef (Manager).
        </p>
      </div>
    );
  }
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="CLIENT">Profiles</option>
              <option value="LEAD">Leads</option>
              <option value="PACKAGE_RECORD">Matches</option>
            </select>
          </div>
        </div>

        <div className="space-y-1.5">
          <label className="text-[10px] font-bold uppercase text-muted-foreground ml-1">Region</label>
          <div className="relative">
